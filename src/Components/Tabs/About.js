...
export class About extends Component{
    render(){
        ...
        <div>
             <h1  className={styles.head}><u>COVID-19</u></h1>
             <Carousel>
<Carousel.Item>
    <img className="d-block w-100" src={imag1} alt="First slide"/>
  </Carousel.Item>
  <Carousel.Item>
    <img className="d-block w-100" src={imag2} alt="Third slide"/>
  </Carousel.Item>
  <Carousel.Item>
    <img className="d-block w-100" src={imag3} alt="Third slide"/>
  </Carousel.Item>
  <Carousel.Item>
    <img className="d-block w-100" src={imag4} alt="First slide"/>
  </Carousel.Item>
  <Carousel.Item>
    <img className="d-block w-100" src={imag5} alt="Third slide"/>
  </Carousel.Item>
  <Carousel.Item>
    <img className="d-block w-100" src={imag6} alt="Third slide"/>
  </Carousel.Item>
</Carousel>  
</div>
<div>
...
{/* 
             <CardDeck>
             <Card style={{ width: '10rem' , height: '24rem'}}>
  <Card.Img variant="top" src={img1} height="160rem" width="10rem" />
  <Card.Body>
...
<Card style={{ width: '10rem', height: '24rem' }}>
  <Card.Img variant="top" src={img2} height="160rem" width="10rem" />
  <Card.Body>
    <Card.Title></Card.Title><Button href="#b" className="btn-lg" variant="outline-success"><b>Click here for more information</b></Button>
    <Card.Text>
    Symptoms of COVID-19 can be relatively non-specific and infected people may be asymptomatic. 
    The two most common symptoms are fever (88 per cent) and dry cough (68 per cent).
    
    </Card.Text>
  </Card.Body>
</Card>
<Card style={{ width: '10rem', height: '24rem' }}>
  <Card.Img variant="top" src={img3} height="160rem" width="10rem" />
  <Card.Body>
    <Card.Title>PREVENTION</Card.Title>
    <Card.Text>
    Strategies for preventing transmission of the disease include maintaining 
    overall good personal hygiene, washing hands, avoiding touching the eyes, nose, or mouth with unwashed hands etc.
...
<div id="a" className={styles.main} ><h1 className={styles.header}><b><u>INTRODUCTION TO COVID‑19</u></b></h1><br></br>
            <h4>The COVID-19 pandemic, also known as the coronavirus pandemic, is an ongoing pandemic of coronavirus disease 2019 (COVID‑19)
...
The virus is primarily spread between people during close contact, most often via small droplets produced by coughing,
 sneezing, and talking.The droplets usually fall to the ground or onto surfaces rather than travelling through air over long distances. Less commonly, people may become infected by touching a contaminated surface and then touching their face.It is most contagious during the first three days after the onset of symptoms, although spread is possible before symptoms appear,
  and from people who do not show symptoms..</h4><br></br><br></br>
</div>
<div id="b" className={styles.main} ><h1 className={styles.header}><b><u>SYMPTOMS OF COVID‑19</u></b></h1><br></br>
            <h4>Symptoms of coronavirus can be relatively non-specific and infected people may be asymptomatic.  The
...
the asymptomatic ratio range from few to 44 per cent.The usual incubation period (the time between infection
 and symptom onset) ranges from one to 14 days, and is most commonly five days.</h4><br></br><br></br>
 </div>
 <div id="c" className={styles.main} ><h1 className={styles.header}><b><u>PREVENTION OF COVID‑19</u></b></h1><br></br>
 <h4>
...
re or how they were infected.<br></br>Basic measures to keep in mind:<br></br>1) Hand washing<br></br>2) Surface cleaning<br></br>3) Face masks and respiratory hygiene<br></br>
4)Social distancing  <br></br>   5)Self Isolation
 </h4>
 </div>
</div>
